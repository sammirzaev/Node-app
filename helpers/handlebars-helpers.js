// RegExp means Regular expressions
// fn() this function will return everything in middle of this function
// option match $&selected="selected"
...
module.exports = {
    ...
    paginate: function(options){
        ...
        for(; i <= (Number(options.hash.current) + 4) && i <= options.hash.pages; i++){
            ...
            //Dots after 4 pages will appear 
